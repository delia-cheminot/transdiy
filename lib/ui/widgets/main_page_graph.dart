...
class MainGraph extends StatelessWidget {
  ...
  final List<int> days = [0, 8, 18, 27, 36, 47, 57, 68, 77, 83, 90];
  final List<double> dosesMg = [6, 4, 4, 5.5, 6, 6, 8, 8, 6.4, 4, 6];
      ...
      LineChartData(
        ...
        lineBarsData: [
          LineChartBarData(
            ...
            barWidth: 3,
            dotData: FlDotData(show: false), // Sans les points
            belowBarData: BarAreaData(
              show: true,
              color:
                  Colors.pinkAccent.withOpacity(0.3), // Dégradé sous la courbe
            ),
          ),
        ],
      ),
...
class GraphCalculator {
  double oestradiolEnanthateSingleInjection(double t, int day, double doseMg) {
    ...
    double part3 = math.exp((-t + day) * k2) * (k3 - k1) / ((k1 - k2) * (k1 - k3) * (k2 - k3));
