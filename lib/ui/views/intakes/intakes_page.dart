        ...
        return MainPageWrapper(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final intakeDate = intake.takenDateTime ?? intake.scheduledDateTime; // TODO make taken non nullable and remove scheduled
              final dateText = DateFormat.yMMMd().format(intakeDate);
              final sideText = intake.side?.label != null ? ' • ${intake.side!.label}' : '';
              return ListTile(
                title: Text(dateText),
